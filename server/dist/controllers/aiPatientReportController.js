...
exports.generateAIPatientReport = generateAIPatientReport;
exports.getAIPatientReports = getAIPatientReports;
exports.reviewAIPatientReport = reviewAIPatientReport;
exports.finalizeAIPatientReport = finalizeAIPatientReport;
exports.exportAIPatientReport = exportAIPatientReport;
const index_js_1 = require("../database/index.js");
async function generateAIPatientReport(req, res) {
    try {
        ...
        if (!targetPatientId) {
            ...
            const defaultPatient = await index_js_1.prisma.patient.findFirst({
                include: { user: true },
            });
            if (defaultPatient)
        ...
        const report = await index_js_1.prisma.aIPatientReport.create({
            data: {
...
async function getAIPatientReports(req, res) {
    try {
        ...
        const reports = await index_js_1.prisma.aIPatientReport.findMany({
...
async function reviewAIPatientReport(req, res) {
    try {
        const { id } = req.params;
        const { doctorNotes, finalClinicalReview } = req.body;
        const existing = await index_js_1.prisma.aIPatientReport.findUnique({
            where: { id },
        ...
        const updated = await index_js_1.prisma.aIPatientReport.update({
            where: { id },
            data: {
...
async function finalizeAIPatientReport(req, res) {
    try {
        const { id } = req.params;
        const { doctorNotes, finalClinicalReview } = req.body;
        const existing = await index_js_1.prisma.aIPatientReport.findUnique({
...
async function exportAIPatientReport(req, res) {
    try {
        const { id, format } = req.params;
        const report = await index_js_1.prisma.aIPatientReport.findUnique({
            where: { id },
            include: { patient: { include: { user: true } } },
        });
        if (!report)
